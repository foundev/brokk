...
public class FuzzyMatcher {
    ...
    public int score(String name) {
        ...
        var headFragment = Objects.requireNonNull(fragments.getHead());
    ...
    private int calculateScore( String name,  FList<TextRange> fragments) {
        ...
        final var first = Objects.requireNonNull(fragments.getHead());
        ...
        boolean finalMatch = Objects.requireNonNull(fragments.getLast()).getEndOffset() == name.length();
...
// ========================================================================
    ...
    private static  FList<TextRange> prependRange( FList<TextRange> ranges, int from, int length) {
        ...
        if (head != null && newRange.getEndOffset() == head.getStartOffset()) {
            ...
            return Objects.requireNonNull(ranges.getTail()).prepend(mergedRange);
        }
