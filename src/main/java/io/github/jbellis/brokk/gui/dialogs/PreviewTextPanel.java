...
public class PreviewTextPanel extends JPanel implements ThemeAware {
    ...
    private void openQuickResultsDialog(String selectedText, String instructions) {
        ...
        new Thread(() -> {
            ...
            } catch (Exception e) { // Catch any other unexpected exceptions from performQuickEdit
                logger.error("Unexpected error during quick edit processing", e);
                quickEditResult = new QuickEditResult(null, "An unexpected error occurred during Quick Edit.");
            } finally {
                                             ...
                                             String selectedText) throws ExecutionException, InterruptedException
    {
        ...
        if (stopDetails.reason() != TaskResult.StopReason.SUCCESS) {
            ...
            // Ensure explanation is not null for QuickEditResult contract
        ...
        // Ensure error explanation is null if snippet is present, per QuickEditResult contract
